...
public class JDBCSiteDAO implements SiteDAO {
    ...
    public List<Site> getAvailableSites(int parkId) {
       ...
       /* "SELECT s.site_id, s.campground_id, site_number, max_occupancy, accessible, max_rv_length, utilities\n" +
                "                FROM site s\n" +
                ...
                "SELECT site_id, site.campground_id, site_number, max_occupancy, accessible, max_rv_length, utilities\n" +
                        "                FROM site\n" +
    ...
    @Override
    public List<Site> getAvaialableSitesDateRange(int parkId, LocalDate fromDate, LocalDate toDate){
